...
public class SubscriptionVASDTO extends BaseDTO  implements Serializable, Attachable<SubscriptionVAS> {
    private ValueAddedServiceDTO vas;
    ...
    public ValueAddedServiceDTO getVas() {
        return vas;
    }

    public void setVas(ValueAddedServiceDTO vas) {
        this.vas = vas;
    }
