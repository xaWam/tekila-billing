 ...
 */
@Stateless(name = "NarfixBillingManager", mappedName = "NarfixBillingManager")
@TransactionManagement(TransactionManagementType.CONTAINER)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class NarfixBillingManager implements BillingEngine {

    private final static Logger log = Logger.getLogger(NarfixBillingManager.class);
    ...
    public void manageLifeCyclePrepaid(Subscription subscription) {
        ...
        log.info("Starting lifecycle management process for Narfix prepaid");
    ...
    public void cancelPrepaid(Subscription subscription) {
        try {
            ...
            subscription = engineFactory.getOperationsEngine(subscription).changeStatus(subscription, SubscriptionStatus.CANCEL);
            subscription.setLastStatusChangeDate(DateTime.now());
    ...
    private void finalizeSubscription(Subscription sub) {
