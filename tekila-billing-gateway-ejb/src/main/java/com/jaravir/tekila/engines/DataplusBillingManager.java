 ...
 */
@Stateless(name = "DataplusBillingManager", mappedName = "DataplusBillingManager")
@TransactionManagement(TransactionManagementType.CONTAINER)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class DataplusBillingManager implements BillingEngine {

    private final static Logger log = Logger.getLogger(DataplusBillingManager.class);
    ...
    public void billPrepaid(Subscription subscription) {
        ...
        if (rate == null) {
            ...
            if (prop == null) {
                rate = 0L;
                //throw new RuntimeException("Could not find monthly price amount");
            } else {
                rate = prop.getPrice();
            }
        }
    ...
    public void manageManualActivation(Subscription subscription) {
        ...
        log.info("Starting manual Dataplus Activation process for prepaid aggr = " + subscription.getAgreement());
//        Subscription subscriptions = subscriptionFacade.findAllNotActivatedPrepaid(Providers.DATAPLUS.getId());
...
//                }
        ...
        log.info(String.format("Dataplus manual Activation process for prepaid Subscription agreement = %d successfully finished", subscription.getAgreement()));
