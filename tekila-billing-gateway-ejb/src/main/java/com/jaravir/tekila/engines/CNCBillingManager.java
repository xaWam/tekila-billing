...
/**
 * Created by ShakirG on 5/16/2017.
 */
@Stateless(name = "CNCBillingManager", mappedName = "CNCBillingManager")
@TransactionManagement(TransactionManagementType.CONTAINER)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class CNCBillingManager implements BillingEngine {

    private final static Logger log = Logger.getLogger(CNCBillingManager.class);
...
//            rate = subscription.getService().getServicePrice();
    ...
    public void manageManualActivation(Subscription subscription) {
        ...
        log.info("Starting manual CNC Activation process for prepaid aggr = " + subscription.getAgreement());
...
//                }
        ...
        log.info(String.format("CNC manual Activation process for prepaid Subscription agreement = %d successfully finished", subscription.getAgreement()));
