 ...
 */
@Stateless(name = "UninetBillingManager", mappedName = "UninetBillingManager")
@TransactionManagement(TransactionManagementType.CONTAINER)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class UninetBillingManager implements BillingEngine {

    private final static Logger log = Logger.getLogger(UninetBillingManager.class);
    ...
    public void manageManualActivation(Subscription subscription) {
        ...
        log.info("Starting manual UniNet Activation process for prepaid aggr = " + subscription.getAgreement());
//        Subscription subscriptions = subscriptionFacade.findAllNotActivatedPrepaid(Providers.UNINET.getId());
...
//                }
        ...
        log.info(String.format("UniNet manual Activation process for prepaid Subscription agreement = %d successfully finished", subscription.getAgreement()));
