 ...
 */
package com.jaravir.tekila.provision.broadband;
 ...
 * @author sajabrayilov
 */
@Stateless(name = "AzertelekomProvisioner", mappedName = "AzertelekomProvisioner")
@Local(ProvisioningEngine.class)
public class AzertelekomProvisioner implements ProvisioningEngine {
    ...
    private static final Logger log = Logger.getLogger(AzertelekomProvisioner.class);
